{% with
    "ginger-test"|member:(m.site.hostname|split:"."),
    "ginger-acceptatie"|member:(m.site.hostname|split:"."),
    "docker"|member:(m.site.hostname|split:".")
as
    isTest,
    isAccept,
    isDocker
...
<div role="navigation" class="navbar navbar-branded navbar-fixed-top
    {% if isTest %}navbar-test{% endif %}
    {% if isAccept %}navbar-accept{% endif %}
    {% if isDocker %}navbar-docker{% endif %}">
